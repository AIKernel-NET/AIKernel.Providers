...
/// <summary>EN: Documentation for public API. JA: OpenAICompatibleResponseProjection を表します。</summary>
...
public sealed record OpenAICompatibleResponseProjection
{
    ...
    /// <summary>EN: Documentation for public API. JA: RawResponse を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PrimaryText を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: IsTruncated を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ObservedAtUtc を取得します。</summary>
