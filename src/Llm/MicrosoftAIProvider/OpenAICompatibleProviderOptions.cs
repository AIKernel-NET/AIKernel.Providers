...
/// <summary>EN: Documentation for public API. JA: ISecureOptions を表します。</summary>
...
public sealed record OpenAICompatibleProviderOptions : ISecureOptions
{
    ...
    /// <summary>EN: Documentation for public API. JA: Endpoint を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SupportsSystemRole を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SupportsAssistantRole を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SupportsToolRole を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SupportsStreaming を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SecretKeyName を取得します。</summary>
